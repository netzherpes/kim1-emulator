...
/* More chars  + unicode whohooo*/
char display_map[256] = {
...
/* 0x50 */    'r', '~', '~', '?', 'n', '~', '~', '~', 'c', '~', '~', '2', 'o', '~', 'd', 'a', 
/* 0x60 */    '~', '~', '~', '~', 'x', '~', '4', '~', '~', '~', '~', '~', '~', '5', 'Y', '9', 
/* 0x70 */    'K', 'F', '~', 'P', 'h', '~', 'H', 'A', 't', 'E', '~', 'e', 'b', '6', 'h', '8', 
/* 0x80 */    ' ', '~', '~', '>', 'I', '~', '1', '7', '_', '~', '~', '~', '~', '~', '~', ']', 
/* 0x90 */    'i', '~', '~', '~', '~', '~', '~', '~', '~', '~', '~', '~', 'u', '~', 'J', '~', 
/* 0xa0 */    '`', '~', '~', '~', '~', '~', '~', '~', '~', '~', '~', '~', '~', '~', '~', '~', 
/* 0xb0 */    'I', '~', '~', '~', '~', '~', '~', 'N', 'L', 'C', '~', '~', '~', 'G', 'U', '0', 
...
/* 0xd0 */    'r', '~', '~', '?', 'n', '~', '~', '~', 'c', '~', '~', '2', 'o', '~', 'd', 'a', 
/* 0xe0 */    '~', '~', '~', '~', 'x', '~', '4', '~', '~', '~', '~', '~', '~', '5', 'Y', '9', 
/* 0xf0 */    'K', 'F', '~', 'P', 'h', '~', 'H', 'A', 't', 'E', '~', 'e', 'b', '6', 'h', '8', 
};
...
/*change new line for just return.... makes it look better*/
void show_display() {
    printf("%c%c%c%c %c%c\r",
